...
const corsOptions = {
    origin: 'https://eagleduty.com' // Replace with the actual domain of EagleDuty
};
...
module.exports = async (req, res) => {
    try {
        ...
        corsHandler(req, res, async () => {
            ...
            const apiURL = `https://api.airtable.com/v0/${baseID}/${tableID}?sort%5B0%5D%5Bfield%5D=data&sort%5B0%5D%5Bdirection%5D=asc`;
