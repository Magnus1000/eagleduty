...
function goStep2() {
    ...
    const ninetyNineJson = selectedResult.getAttribute("data-99-json");
    ...
    selectedResultCard.setAttribute('data-99-json', ninetyNineJson);
...
function addEventListenerToSelectButton() {
    ...
    buttonSelect.addEventListener("click", (event) => {
        ...
        const radioToSelect = radiosContainer.querySelector(`input[type="radio"][name="htsno"][value="${buttonHtsno}"]`);
